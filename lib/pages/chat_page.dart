...
import 'package:flutter_chatui/commom/win_media.dart';
import 'package:flutter_chatui/config/const.dart';
import 'package:flutter_chatui/config/contacts.dart';
import 'package:flutter_chatui/widgets/bar/common_bar.dart';
import 'package:flutter_chatui/widgets/chat/chat_details_body.dart';
import 'package:flutter_chatui/widgets/chat/chat_details_row.dart';
import 'package:flutter_chatui/widgets/edit/emoji_text.dart';
import 'package:flutter_chatui/widgets/edit/text_span_builder.dart';
import 'package:flutter_chatui/widgets/view/main_input.dart';
import '../tools/data.dart';
import '../tools/notice.dart';
  ...
  Widget build(BuildContext context) {
    ...
    var body = [
      ...
      new ChatDetailsRow(
        ...
        edit: edit,
        more: new Text(
            'ChatMoreIcon') /*TODO: new ChatMoreIcon(
      ...
      new Container(
          ...
          child: new Text(
              'IndicatorPageView') /*TODO: new IndicatorPageView(
          pageC: pageC,
    ...
    var rWidget = [
      new InkWell(
          ...
          onTap:
              null /*TODO: () => routePush(widget.type == 2
