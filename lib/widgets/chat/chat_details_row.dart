...
import 'package:flutter_chatui/tools/data.dart';
import 'package:flutter_chatui/tools/notice.dart';
            ...
            new Expanded(
              child: new Container(
                ...
                child: widget.isVoice
                    ? new Text('ChatVoice') //TODO: new ChatVoice(voiceFile: (path) {setState(() => this.path = path);})
